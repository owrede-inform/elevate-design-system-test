...
const InformLogo = () => (
  <svg width="80" height="12" viewBox="0 0 284 45" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M0.200001 44H38L49.8 1.5H12L0.200001 44Z" fill="#0090A7"/>
    <path d="M172.1 0.799988C159.4 0.799988 151.1 4.09999 151.1 22.8C151.1 41.5 159.2 44.8 172 44.8C184.8 44.8 193 41.4 193 22.7C192.9 3.99999 184.8 0.799988 172.1 0.799988ZM181.1 24.5C181.1 32.5 179.2 35.4 172.1 35.4C165.1 35.4 163 32.4 163 24.4V21C163 13 165 10.4 172 10.4C179.1 10.4 181.1 13.1 181.1 21.1V24.5Z" fill="white"/>
